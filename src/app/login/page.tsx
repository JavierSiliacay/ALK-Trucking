...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row font-manrope bg-white lg:overflow-hidden">
      {/* LEFT — Brand Panel */}
      <div 
        className="flex w-full h-[260px] sm:h-[320px] lg:h-full lg:w-[55%] relative overflow-hidden flex-col justify-between p-6 lg:p-12 bg-cover bg-center shrink-0"
        style={{ backgroundImage: "url('/truck-bg.jpg')" }}
      >
        {/* Dark overlays to ensure text remains readable */}
        <div className="absolute inset-0 bg-[#00193c]/80 mix-blend-multiply pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#00122e] via-transparent to-transparent pointer-events-none" />
        ...
        {/* Logo (Hidden on mobile as it's shown in form) */}
        ...
        {/* Center content (Hidden on mobile to keep banner clean) */}
        <div className="hidden lg:flex relative z-10 flex-1 flex-col justify-center mt-12">
          <motion.div
        ...
        {/* Bottom */}
        <div className="hidden lg:flex relative z-10 items-center gap-2 text-white/40 text-xs">
      ...
      {/* RIGHT — Login Form */}
      <div className="flex-1 w-full flex items-center justify-center p-8 bg-white rounded-t-[2rem] lg:rounded-none -mt-8 lg:mt-0 relative z-10 shadow-[0_-8px_30px_rgba(0,0,0,0.12)] lg:shadow-none min-h-[500px]">
        <motion.div
